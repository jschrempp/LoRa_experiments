...
#define BUTTON_PIN_DIGITAL 0
#define LED_PIN_DIGITAL 7
#define TPP_LORA_DEBUG 1
#define SENSOR_DEBUG 1  // always 0 for Arduino
...
DEBUG_SERIAL.println("Sensor finished setup");
    ...
    switch (LoRa.receivedMessageState) {
      ...
      case 1:  // message received
        ...
        if (LoRa.receivedData.indexOf("+RCV") >= 0) {  // will be -1 of "+RCV" not in the string
          ...
          DEBUG_SERIAL.println("response: " + LoRa.receivedData);
