 ...
 *
 *    
 *    Version 1.30, by Bob Glicksman, 12/16/24
 *      this version eliminates the delay after transmission, as it is not necessary.  This version changes
...
uint8_t msgNum = 0; // one up message number
